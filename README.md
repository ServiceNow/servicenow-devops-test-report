# ServiceNow DevOps Register JUnit Test Summary Report GitHub Action

This custom action needs to be added at step level in a job to register JUnit test summary report in ServiceNow instance.
...
build:
    ...
    steps:
      - name: Send JUnit Test Report Step
...
**Required**  Display name of the job given for attribute _name_ in which _steps_ have been added for JUnit test summary report custom action.

### `xml-report-filename`

**Required**  JUnit xml summary report file name with relative path.
