...
(function() {
  ...
  builder = __nccwpck_require__(854);

  defaults = (__nccwpck_require__(760).defaults);
...
(function() {
  ...
  sax = __nccwpck_require__(880);

  events = __nccwpck_require__(361);

  bom = __nccwpck_require__(891);

  processors = __nccwpck_require__(917);
...
(function() {
  ...
  defaults = __nccwpck_require__(760);

  builder = __nccwpck_require__(761);

  parser = __nccwpck_require__(616);
...
(function() {
  ...
  NodeType = __nccwpck_require__(162);

  XMLNode = __nccwpck_require__(859);
...
(function() {
  ...
  XMLCharacterData = __nccwpck_require__(356);
...
(function() {
  ...
  XMLDOMErrorHandler = __nccwpck_require__(986);

  XMLDOMStringList = __nccwpck_require__(428);
...
(function() {
  ...
  isObject = (__nccwpck_require__(842).isObject);
...
(function() {
  ...
  XMLDTDAttList = __nccwpck_require__(473);

  XMLDTDEntity = __nccwpck_require__(516);

  XMLDTDElement = __nccwpck_require__(927);

  XMLDTDNotation = __nccwpck_require__(515);

  XMLNamedNodeMap = __nccwpck_require__(894);
...
(function() {
  ...
  isPlainObject = (__nccwpck_require__(842).isPlainObject);

  XMLDOMImplementation = __nccwpck_require__(300);

  XMLDOMConfiguration = __nccwpck_require__(957);

  XMLNode = __nccwpck_require__(859);

  NodeType = __nccwpck_require__(162);

  XMLStringifier = __nccwpck_require__(66);

  XMLStringWriter = __nccwpck_require__(751);
...
(function() {
  ...
  ref = __nccwpck_require__(842), isObject = ref.isObject, isFunction = ref.isFunction, isPlainObject = ref.isPlainObject, getValue = ref.getValue;

  NodeType = __nccwpck_require__(162);

  XMLDocument = __nccwpck_require__(958);

  XMLElement = __nccwpck_require__(609);

  XMLCData = __nccwpck_require__(969);

  XMLComment = __nccwpck_require__(353);

  XMLRaw = __nccwpck_require__(658);

  XMLText = __nccwpck_require__(226);

  XMLProcessingInstruction = __nccwpck_require__(458);

  XMLDeclaration = __nccwpck_require__(527);

  XMLDocType = __nccwpck_require__(128);
  ...
  XMLAttribute = __nccwpck_require__(605);

  XMLStringifier = __nccwpck_require__(66);

  XMLStringWriter = __nccwpck_require__(751);

  WriterState = __nccwpck_require__(280);
...
(function() {
  ...
  ref = __nccwpck_require__(842), isObject = ref.isObject, isFunction = ref.isFunction, getValue = ref.getValue;
...
(function() {
  ...
  ref1 = __nccwpck_require__(842), isObject = ref1.isObject, isFunction = ref1.isFunction, isEmpty = ref1.isEmpty, getValue = ref1.getValue;
  ...
  module.exports = XMLNode = (function() {
    function XMLNode(parent1) {
      ...
      if (!XMLElement) {
        ...
        XMLText = __nccwpck_require__(226);
        XMLProcessingInstruction = __nccwpck_require__(458);
        XMLDummy = __nccwpck_require__(179);
        NodeType = __nccwpck_require__(162);
        XMLNodeList = __nccwpck_require__(137);
        XMLNamedNodeMap = __nccwpck_require__(894);
        DocumentPosition = __nccwpck_require__(71);
      }
    }
...
(function() {
  ...
  XMLWriterBase = __nccwpck_require__(383);
...
(function() {
  ...
  assign = (__nccwpck_require__(842).assign);
...
(function() {
  ...
  ref = __nccwpck_require__(842), assign = ref.assign, isFunction = ref.isFunction;

  XMLDOMImplementation = __nccwpck_require__(300);

  XMLDocument = __nccwpck_require__(958);

  XMLDocumentCB = __nccwpck_require__(220);

  XMLStringWriter = __nccwpck_require__(751);

  XMLStreamWriter = __nccwpck_require__(152);
...
const xml2js = __nccwpck_require__(929);
const axios = __nccwpck_require__(540);
